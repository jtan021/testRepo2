                ...
                if let requests = usersRequests {
                    for request in requests {
                        ...
                        // If job is not expired, continue to add it to the TableViewData
                            ...
                            // Select image depending on category
                            ...
                            let newPendingRequestItem = PendingRequestItem(JobID: jobID!, Title: jobTitle, Address: jobAddress, Category: jobCategory, Description: jobDescription, LifeRemaining: lifeRemaining, OfferForCompletion: jobOfferForCompletion, Keywords: jobKeywords, Status: currentStatus, CompletionStatus: jobCompletionStatus, Employee: jobEmployee)
